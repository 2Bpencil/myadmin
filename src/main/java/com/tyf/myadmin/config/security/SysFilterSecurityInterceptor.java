...
public class SysFilterSecurityInterceptor extends AbstractSecurityInterceptor implements Filter {
    ...
    @Autowired
    public void setMyAccessDecisionManager(SysAccessDecisionManager accessDecisionManager) {
